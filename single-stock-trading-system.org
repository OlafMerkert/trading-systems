...
Let's also try to randomise the invested volume a little bit.
#+begin_src lisp
(defun random-factor (&optional (center 1) (spread 0.2))
  "A uniform distribution around `center' of width 2 * `spread'."
  (- center spread (random (* 2 spread))))
#+end_src
